        ...
        <main className={"relative"}>
            ...
            <div className={"md:max-w-[907px] mt-28 mb-[80px] relative mx-auto grid grid-cols-4 md:grid-cols-12"}>
                ...
                <section className={"order-2 md:order-1 col-span-4 md:col-span-6"}>
                    <div className={""}>
                        <h3 className={"hidden md:block text-[#233348] col-start-1 col-end-3 md:text-[48px] font-bold md:leading-[56px]"}>Your
                            Bike <br/> <span>Electric Update</span>
                        </h3>

                        {/*Visible on mobile only*/}
                        <h3 className={"md:hidden text-center mt-[40px] mb-[30px] text-[#233348] leading-[40px]  text-[35px] font-semibold"}>
                           Your Bike Electric Update
                        </h3>

                        <p className={"text-[21px] px-5 md:px-0 text-center md:text-left mt-[14px] md:mt-[24px] text-[#7D7987] md:w-[95%]"}>Dummy text progressive, and
                            affordable
                        ...
                        <div
                            ...
                            <input type="text" className={"flex-1 text-gray-500 h-full bg-gray-50 outline-none border-none text-[14px] ml-2"}
                                   placeholder={"Search Bike or anything"}/>
                            <button className={"bg-[#FFBD37] w-[109px] h-[40px] rounded-full"}>Find</button>
                        </div>
                    </div>
                </section>
