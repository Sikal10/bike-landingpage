...
const Bike = () => {
    return (
        <main>
            <section className={"hidden md:block relative mb-[105px] bg-gray-50"}>
                ...
                <div className={" mx-auto relative"}>
                    <div className={"mt-12 justify-end space-x-7 flex items-center"}>
                        {/*card1*/}
                        <section className={"py-4 px-7 w-[382.2px] h-[375.23px] rounded-2xl bg-white shadow-md"}>
                            <h2 className={"text-[20px] text-[#233348] font-bold"}>Universal eBike Kit</h2>
                            <img src="/images/brampton.png" className={"w-[199px] object-contain h-[229px] block mx-auto"}
                                 alt=""/>
                            <hr className={"bg-[#C2CFE0] border"}/>
                            <p className={"text-[#7D7987] mt-2 text-[16px]"}>Price</p>
                        ...
                        {/*card3*/}
                        <section className={"py-4 opacity-25 px-7 w-[382.2px] h-[375.23px] rounded-2xl bg-white shadow-md"}>
                            <h2 className={"text-[20px] text-[#233348] font-bold"}>Universal eBike Kit</h2>
                            <img src="/images/brampton.png" className={"w-[199px] object-contain h-[229px] block mx-auto"}
                                 alt=""/>
                            <hr className={"bg-[#C2CFE0] border"}/>
