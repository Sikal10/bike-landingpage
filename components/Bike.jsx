    ...
    return (
        <main>
            <section id={"#product"} className={"hidden md:block relative mb-[105px] bg-gray-50"}>
                ...
                <div className={"relative overflow-x-scroll pb-4 border border-black scrollbar-thumb-gray-100 scrollbar-thin"}>
                    <div className={"mt-12 justify-end py-4 space-x-7 w-[85vw] ml-80 flex items-center"}>
                        {/*card1*/}
                        <section className={"flex-1 py-4 px-7 min-w-[400px] h-[375.23px] rounded-2xl bg-white shadow-lg"}>
                        ...
                        {/*card3*/}
                        <section className={"flex-1 py-4 opacity-25 px-7 min-w-[400px] h-[375.23px] rounded-2xl bg-white shadow-lg"}>
                            <h2 className={"text-[20px] text-[#233348]  font-mulish font-bold"}>Universal eBike Kit</h2>
                            <img src="/images/brampton.png" className={"w-[199px] object-contain h-[229px] block mx-auto"}
                                 alt=""/>
                            <hr className={"bg-[#C2CFE0] border"}/>
