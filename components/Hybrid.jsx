        ...
        <main className={"pb-20 mt-[108px] mb-[80px] md:mb-[138px] relative"}>
            ...
            <div className={"mt-10 max-w-[907px] relative grid grid-cols-4 md:grid-cols-12 mx-auto"}>
               ...
               <section className=" col-span-full md:col-span-6">
                   <section className={"md:px-7 px-5 mx-5 md:mx-0 md:w-[420px] py-4 rounded-2xl bg-white shadow-md"}>
               ...
               <section className={"col-span-full md:col-span-6 md:ml-[62px] py-9"}>
                   ...
                   <p className={"mt-[32px] hidden md:block text-[#7D7987] text-[18px]"}>
                   ...
                   <p className={"mt-[32px] md:hidden px-3 text-center text-[#7D7987] text-[18px]"}>
                       Dummy Text progressive, and affordable healthcare, accessible on mobile and online for everyone.
                       To us, it’s not just work. We take pride in the solutions we deliver
                   </p>

                   <button className={"hidden md:block border-2 text-[18px] border-[#FCB72B] w-[200px] h-[56px] rounded-full text-[#FCB72B] font-bold mt-[37px]"}>Learn more</button>

                    <div className={"md:hidden flex justify-center -mt-2"}>
                        <button className={"md:hidden border text-[18px] border-[#FCB72B] w-[200px] h-[56px] rounded-full text-[#FCB72B] font-bold mt-[37px]"}>Learn more</button>
                    </div>
               </section>
           </div>
        </main>
